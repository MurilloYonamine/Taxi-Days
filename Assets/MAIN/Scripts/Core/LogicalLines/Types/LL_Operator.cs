...
namespace DIALOGUE.LogicalLines
{
    public class LL_Operator : ILogicalLine
    {
        ...
        /*
        Logical line to declare and modify
        variables within a dialogue file
        */
        ...
        public IEnumerator Execute(DIALOGUE_LINE line)
        {
            ...
            if (parts.Length < 3)
            {
                Debug.LogError($"Comando inválido: {trimmedLine}");
                yield break;
            }
            ...
            if (value == null)
            {
                Debug.LogError($"Valor inválido: {trimmedLine}");
                yield break;
            }
        ...
        private void ProcessOperatorOnVariable(string variable, string op, object value, object currentValue)
        {
            switch (op)
            {
                ...
                case "/=":
                    ...
                    break;
                default:
                    Debug.LogError($"Operador inválido: {op}");
                    break;
            }
        }
