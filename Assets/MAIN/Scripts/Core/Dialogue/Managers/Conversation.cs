...
namespace DIALOGUE
{
    ...
    {
        /*
        Data Container for a conversation
        including its lines and progress.
        */
        ...
        public Conversation(List<string> lines, int progress = 0, string file = "", int fileStartIndex = -1, int fileEndIndex = -1)
        {
            ...
            if (fileStartIndex == -1) this.fileStartIndex = 0;
            if (fileEndIndex == -1) this.fileEndIndex = lines.Count - 1;
