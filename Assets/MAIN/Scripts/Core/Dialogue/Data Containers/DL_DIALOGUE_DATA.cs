    ...
    public class DL_DIALOGUE_DATA
    {
        ...
        */
        ...
        public List<DIALOGUE_SEGMENT> RipSegments(string rawDialogue)
        {
            ...
            int lastIndex = 0; // find the first or only segment in the file
            ...
            for (int i = 0; i < matches.Count; i++)
            {
                ...
                //Get the start signal for the sigment
                string signalMatch = match.Value; //{A} also the brackets
                signalMatch = signalMatch.Substring(1, match.Length - 2); // A = just inside, no  brackets
