...
namespace COMMANDS
{
    public class CMD_DatabaseExtension_General : CMD_DatabaseExtension
    {
        ...
        private static void LoadNewDialogueFile(string[] data)
        {
            ...
            if (file == null)
            {
                Debug.LogWarning($"File '{filePath}' não pode ser carrega de dialogue files. Por favor verifique se existe em '{FilePaths.resources_dialogueFiles}' resources folder.");
                return;
            }
